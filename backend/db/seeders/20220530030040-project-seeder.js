...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('Projects', [
      ...
      {title: 'Zuora', ownerId: 52, description: 'A clone of "Quora" created with an Express backend and a Pug frontend.'},
      ...
      {title: 'filmdium', ownerId: 45, description: 'Clone of Medium, it\'s a website where people can share thoughts about any movie they have watched and share it.'},
      ...
      {title: 'Duckit List', ownerId: 28, description: 'Anything is posisble, especially when you write it down. With Duckit List, you can create, view, update and share your bucket lists of adventures, travels, life-long goals and many more!'},
      {title: 'Don\'t Forget the Tea', ownerId: 11, description: 'Don\'t Forget The Tea is a boba-themed web application inspired by Remember The Milk, a to-do list website where users can keep track of their tasks and organize them into lists. Our goal is to make getting tasks done a priori-tea!'},
      {title: 'Zuora', ownerId: 5, description: 'Project Zuora is a Quora clone for practice with Express, Pug, CSS, and front end vanilla DOM manipulation. The full stack app will have functionality to ask a question that other users can answer. Then comments can be made on those answers.'},
      ...
      {title: 'week-12-squad-project', ownerId: 31, description: 'We have decided to create a clone of StackOverFlow in combination with the stylistic aspects of Twitter. Basically following a simple question-answer social media platform. Hopefully one that has a topic that\'s relevant and fun.'}
    ], {})
  },
